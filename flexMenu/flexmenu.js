	...
	$.fn.flexMenu = function (options) {
		var checkFlexObject,
			s = $.extend({
				...
				'linkText' : 'Еще <span class="glyphicon glyphicon-triangle-bottom"></span>', // [string] What text should we display on the "view more" link?
        ...
        for (i = numItems; i > 1; i--) {
					...
					if (i <= s.cutoff) { // We've removed the ith item, so i - 1 gives us the number of items remaining.
