...
window.onload=function(){for(var e=document.querySelectorAll(".c-hamburger"),i=e.length-1;0<=i;i--){var t=e[i];t.addEventListener("click",function(e){e.preventDefault(),!0===this.classList.contains("is-active")?this.classList.remove("is-active"):this.classList.add("is-active")})}new Swiper(".slider-top",{pagination:{el:".swiper-pagination",clickable:!0}}),new Swiper(".slider-blog",{loop:!0,slidesPerView:3,centeredSlides:!0,effect:"coverflow"});new Cocoen(document.querySelector(".cocoen"))};